...
snps.DT <- fread('/home/ob219/share/as_basis/GWAS/snp_manifest/psa_gwas_myositis.tab')
...
tmp[,trait:= 'myositis_myogen']
saveRDS(tmp,file='/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_myogen_myositis_cut_down_source.RDS')
...
saveRDS(all.proj,file='/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_myogen_myositis_cut_down.RDS')
...
for (trait in c('jdm','pm','dm')){
  ...
  of <- sprintf('/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_%s_myositis_cut_down_source.RDS',trait)
  saveRDS(tmp,file=of)
  B <- dcast(tmp,pid ~ trait,value.var='metric')
  snames <- B[,1]$pid
  mat.emp <- as.matrix(B[,-1]) %>% t()
  ...
  stop("Something wrong basis and projection matrix don't match")
  all.proj <- predict(pc.emp,newdata=mat.emp)
  saveRDS(all.proj,file=sprintf('/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_%s_myositis_cut_down.RDS',trait))
}

## collate and project

myogen <- readRDS('/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_myogen_myositis_cut_down.RDS')
...
jdm <- readRDS('/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_jdm_myositis_cut_down.RDS')
jdm <- data.table(trait=rownames(jdm),jdm)
jdm <- melt(jdm,id.var='trait')
jdm[,c('n0','n1'):=list(4724,473)]
jdm[,category:='myogen']

dm <- readRDS('/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_dm_myositis_cut_down.RDS')
dm <- data.table(trait=rownames(dm),dm)
dm <- melt(dm,id.var='trait')
dm[,c('n0','n1'):=list(4724,705)]
dm[,category:='myogen']

pm <- readRDS('/home/ob219/share/as_basis/GWAS/myogen_myositis/psa_pm_myositis_cut_down.RDS')
...
saveRDS(all.DT,"~/share/psa_myogen_cut_down_projection_results_26_03_2019.RDS")
