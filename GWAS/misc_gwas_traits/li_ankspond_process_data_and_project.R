...
as.DT <- fread("/home/ob219/share/Data/GWAS-summary/li_mefv/meta.txt")
m <- merge(as.DT,uk10,by.x='MarkerName',by.y='ID')
...
M <- M[g.class %in% c('match','comp'),or:=1/or]
...
tmp[,trait:= 'li_as']
saveRDS(tmp,file='/home/ob219/share/as_basis/GWAS/li_ankspond/li_ankspond.RDS')
