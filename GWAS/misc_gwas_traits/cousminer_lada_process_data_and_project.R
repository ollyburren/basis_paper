...
alleles <- data.table(pid=M$pid,al.x = paste(M$ref_a1,M$ref_a2,sep='/'),al.y=paste(M$ref_a1,M$a2,sep='/'))
...
tmp[,trait:= 'cousminer_lada']
saveRDS(tmp,file='/home/ob219/share/as_basis/GWAS/cousminer_lada/cousminer_lada.RDS')
