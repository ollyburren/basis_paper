...
if(FALSE){
  ...
  SCRIPT <- "/home/ob219/git/basis_paper/GWAS/sun_pqtl/sun_process_and_project_filter.R"
  sprintf("Rscript %s -f %s",SCRIPT,cfiles) %>% write(.,"~/tmp/qstuff/sun_pqtl_filter.txt")
}

processPQTL <- function(dir,filter){
