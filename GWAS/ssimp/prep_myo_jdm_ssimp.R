...
myo.DT <- fread("/home/ob219/share/Data/GWAS-summary/MYOGEN/Dec2018/gwas_jdm.meta")
...
fq <- fread("~/share/Data/GWAS-summary/MYOGEN/Sep2018/jdm.frq")
...
write.table(myo.filt[!is.na(Z),],file='/home/ob219/rds/hpc-work/ssimp/myo_jdm_gwas_with_or.txt',row.names=FALSE,sep=" ",quote=FALSE)
myo.filt <- merged.pid[,.(MarkerName=SNP,Allele1=REF,Allele2=ALT,Z=qnorm(P/2,lower.tail=FALSE) * sign(log(OR)),n)]
write.table(myo.filt[!is.na(Z),],file='/home/ob219/rds/hpc-work/ssimp/myo_jdm_gwas.txt',row.names=FALSE,sep=" ",quote=FALSE)

#NEED ALL THIS FOR IT TO WORK
#export LC_ALL=C; unset LANGUAGE

/home/ob219/git/ssimp_software/compiled/ssimp-linux-0.5.6 --gwas /home/ob219/rds/hpc-work/ssimp/myo_jdm_gwas.txt --ref 1KG/EUR --out /home/ob219/rds/hpc-work/ssimp/myo_jdm_gwas_imputed.txt --impute.maf 0.01
