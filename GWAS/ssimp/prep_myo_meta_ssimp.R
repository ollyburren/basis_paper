...
#OUT_DIR <-
#mapfiles <- list.files(path='/home/ob219/rds/hpc-work/impg/chr1/maps',pattern="*.map",full.names=TRUE)
#myo.DT <- fread("zcat ~/share/Data/GWAS-summary/MYOGEN/Sep2018_summary_meta.txt.gz")
myo.DT <- fread("/home/ob219/share/Data/GWAS-summary/MYOGEN//Sep2018/gwas_dmjdmpm_new.meta")
...
fq <- fread("~/share/Data/GWAS-summary/MYOGEN/Sep2018/dmjdmpm.frq")
...
write.table(myo.filt[!is.na(Z),],file='/home/ob219/rds/hpc-work/ssimp/myogwas_with_or.txt',row.names=FALSE,sep=" ",quote=FALSE)
myo.filt <- merged.pid[,.(MarkerName=SNP,Allele1=REF,Allele2=ALT,Z=qnorm(P/2,lower.tail=FALSE) * sign(log(OR)),n)]
write.table(myo.filt[!is.na(Z),],file='/home/ob219/rds/hpc-work/ssimp/myogwas.txt',row.names=FALSE,sep=" ",quote=FALSE)

#NEED ALL THIS FOR IT TO WORK
#export LC_ALL=C; unset LANGUAGE
#/home/ob219/git/ssimp_software/compiled/ssimp-linux-0.5.6 --gwas /home/ob219/rds/hpc-work/ssimp/myogwas.txt --ref 1KG/EUR --out /home/ob219/rds/hpc-work/ssimp/myogwas_imputed.txt --impute.maf 0.01

/home/ob219/git/ssimp_software/compiled/ssimp-linux-0.5.6 --gwas /home/ob219/rds/hpc-work/ssimp/myogwas_chr1.txt --ref 1KG/EUR --out /home/ob219/rds/hpc-work/ssimp/myogwas_imputed_chr1.txt --impute.maf 0.01
