...
saveRDS(for.reg,file="/home/ob219/scratch/as_basis/raj_cd14_ind_analysis/regression_analysis/cd14.RDS")
for.reg <- readRDS("/home/ob219/scratch/as_basis/raj_cd14_ind_analysis/regression_analysis/cd14.RDS")
