...
OUT_DIR <- '/home/ob219/share/as_basis/GWAS/bb_projections/0619_ICD/'
...
if(FALSE){
  ...
  med <- pheno[grepl("ICD10",Phenotype.Description) & Sex=='both_sexes',]
  cmds <- sapply(1:nrow(med),function(i){
  #cmds <- sapply(c(165,159,78,167,116,57,166),function(i){
    sprintf("Rscript /home/ob219/git/basis_paper/GWAS/UK_BIOBANK/process_bb_icd.R -i %d",i)
  })
  write(cmds,file="~/tmp/qstuff/icd_bb.txt")
}
